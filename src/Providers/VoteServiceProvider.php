    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            $assets = [
                __DIR__.'/../../resources/assets/web' => public_path('assets/votes'),
                __DIR__.'/../../resources/assets/admin' => public_path('admin_assets/js/votes'),
            ];
            $config = [
